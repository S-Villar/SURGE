...
cd /pscratch/sd/a/asvillar/m3dc1_batch/batch_N
...
out_root: /pscratch/sd/a/asvillar/m3dc1_batch
...
**Output:**
```
/pscratch/sd/a/asvillar/m3dc1_batch/batch_3/
├── run1/
│   ├── sparc_1300/
...
```bash
cd /pscratch/sd/a/asvillar/m3dc1_batch/batch_3
sbatch batchjob.perlmutter
```
...
### Batch Configuration
- **Batch**: `batch_3`
- **Location**: `/pscratch/sd/a/asvillar/m3dc1_batch/batch_3`
- **Runs**: 10
