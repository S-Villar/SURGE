...
ROSE lives at `/global/homes/a/asvillar/src/ROSE`. It was previously 61 commits behind `origin/main` and has been fast-forwarded to the current `main`, including UQ active-learning examples under `examples/active_learn/uq/` and tracking integrations.
...
- **Pull status:** ROSE updated at `/global/homes/a/asvillar/src/ROSE`.
